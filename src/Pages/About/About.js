        ...
        <div className="about-card">
          ...
          <div className="team">
            <section className="team-box">
              <div>
                <img className="team-box-img" src={Founder} />
                <button
                  className="team-img-btn"
                  onClick={() => {
                    setShowModal({
                      open: true,
                      title: "Akbar Kholmuradov",
                      text: "Having graduated the International Economic Relations department of the University of World Economy and Diplomacy in 2001, Akbar dedicated his later years to translation and localization. When working as a translator in various huge projects, he faced the difficulty in finding reliable sources that can be used in translation to/from Uzbek language, and as a result some books for English learners and translators were published",
                    });
                  }}
                >
                  Read more
              ...
              <h4>Akbar Kholmuradov</h4>
              <hr />
              <p>Founder and content manager</p>
              <button
                className="team-btn"
                onClick={() => {
                  setShowModal({
